...
import { getData, parseXLSHungary } from './loader'; // getData will return luxembourg's data so far
...
app.get('/readXLS-cyprus', (request, response) => {
    ...
    response.send(parseXLSHungary(['data/source_files/hungary/hungary.xls']));
});
///////////////////////////////////////////////////////
